...
// These headers are generated by the Android build system and need to be
...
// We need 3 for ValidateArchitecture and 1 for ExamineSyscall and 4 for
// ValidateArchitectureAndJumpIfNeeded + 2 extra Disallow
...
static void install_filter(const Filter *f) {
  ...
  // This assumes either the current process has CAP_SYS_ADMIN, or
  // PR_SET_NO_NEW_PRIVS bit is set.
