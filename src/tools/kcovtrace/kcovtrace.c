...
// It is very simplistic at this point and does not support multithreaded
// processes, etc. It can be used to understand, for example, exact location
// where kernel bails out with an error for a particular syscall.
